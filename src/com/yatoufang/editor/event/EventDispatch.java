package com.yatoufang.editor.event;
...
/**
 * @author hse
 * @since 2022/09/29 0029
 */
@SuppressWarnings("all")
public class EventDispatch extends LayerUI<JComponent> {
    ...
    /**
     * Process the mouse events and map the mouse coordinates inverting the internal
     * affine transformation. It consumes the original event, calculates the mapped
     * mouse coordinates and find the real target of the mouse event. It than create
     * a new event with the correct information in it and redispatch it to the
     * target event
     *
